...
//            .property("IsGold", &MOPixel::IsGold),
	...
	*/
		...
		Bind["GetLoadout"] = (Actor * (PresetMan::*)(std::string, std::string, bool)) & PresetMan::GetLoadout; // adopt 0
		Bind["GetLoadout"] = (Actor * (PresetMan::*)(std::string, int, bool)) & PresetMan::GetLoadout; // adopt 0
